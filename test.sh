...
BASE_EXPERIMENT_DIR=/scratch.global/chen8596/mlcommons_experiments_train_test_prob
BASE_LOG_DIR=/scratch.global/chen8596/mlcommons_experiments_train_test_prob/logs
