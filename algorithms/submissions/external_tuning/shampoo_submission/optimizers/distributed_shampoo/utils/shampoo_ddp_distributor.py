...
from algorithms.submissions.external_tuning.shampoo_submission.optimizers.distributed_shampoo.shampoo_types import (
    CommunicationDType,
    DDPShampooConfig,
    PARAMS,
)
from algorithms.submissions.external_tuning.shampoo_submission.optimizers.distributed_shampoo.utils.shampoo_block_info import DDPBlockInfo
from algorithms.submissions.external_tuning.shampoo_submission.optimizers.distributed_shampoo.utils.shampoo_distributor import (
    DistributorInterface,
)
from algorithms.submissions.external_tuning.shampoo_submission.optimizers.distributed_shampoo.utils.shampoo_utils import (
    compress_list,
