...
def init_optimizer_state(
  ...
  scheduler = LineSearchScheduler(optimizer=optimizer, num_search=16, start_lr=1, model_paras=list(model_params.parameters()), optimizer_type="SGD", injection=False, search_mode="bisection")
